...
class person_data {
    ...
    Gender: string
    Age: number
    National_ID_card_number: number
    Phone_number: number
    Email: string
    Date: string
    Time: string
    constructor(name: string, father_name: string, surname: string, gender: string, age: number, national_ID_card_number: number, phone_number: number, email: string, date: string, time: string) {
        this.Name = name
